...
namespace Tests.Editor
{
    public class MatchFinderShould
    {
        ...
        [TestCase(5, 5, new[]
        {
            //Match
            // a  b  c
            0, 2, 0, 1, 0, //Match a: V(2,2,2,2)
            0, 2, 3, 1, 3,
            1, 2, 3, 3, 2, //Match b: V(3,3,3,3)
            2, 2, 3, 3, 2,
            3, 3, 3, 3, 3  //d Match c: V(3,3,3) Match d:H(3,3,3,3,3) 
        }, 4)]
        [TestCase(5, 5, new[]
        {
            /*Match
            a  b  c  d  e*/
            0, 2, 0, 0, 0, //Match a: V(0,0,0) H(0,0,0)
            0, 2, 0, 3, 2, //Match b: (2,2,2,2,2)
            0, 2, 3, 3, 2, //Match c: (3,3,3)
            2, 2, 3, 3, 2, //Match d: (3,3,3,3)
            3, 2, 3, 3, 3 //Match e: (2,2,2) (3,3,3)
        }, 7)]
        [TestCase(8, 8, new[]
        {
            /*Match
            ...
            2, 1, 3, 0, 2, 3, 2, 0, //Match c: (3,3,3)
            2, 2, 3, 2, 2, 3, 3, 2, //Match d: (2,2,2)
            2, 3, 3, 3, 3, 3, 3, 3, //Match e: (3,3,3) (3,3,3,3,3,3,3)
            2, 2, 2, 4, 2, 2, 1, 3, //Match (2,2,2)
            2, 2, 2, 4, 2, 2, 1, 0, //Match (2,2,2)
            2, 2, 1, 2, 3, 3, 2, 1
        },9)]
        public void Find_Both_Matches_Vertical_And_Horizontal(int rows, int columns, int[] grid, int expectedMatches)
        {
            _grid = new Grid(rows, columns);
            _grid.PopulateWithProvidedTiles(grid);
            _matchFinder = new MatchFinder(_grid);
